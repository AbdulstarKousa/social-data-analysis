To run the code, "Motor_Vehicle_Collisions.py", correctly: 
you need to download the relevant datasets from the below links (only visible to our group member)
and put them in the same directory with the code. 

DataSets (the links are only visible to the group member): 
...
Meta-data (DataSets description): 
    ...
    - Weather MetaData: https://dtudk-my.sharepoint.com/:b:/g/personal/s174360_dtu_dk/EftQZ3Gwy6JMs6pzDjd1u74B2z6ww2dqKWOEaI49JETGKg?e=aDn4Co